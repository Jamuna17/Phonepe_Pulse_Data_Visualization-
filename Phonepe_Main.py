...
icon = Image.open("D:/phonepe project/ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Jamunadevi*!
...
# MENU 1 - HOME
if selected == "Home":
    st.image("D:/phonepe project/img.png")
    ...
    with col2:
        st.image("D:/phonepe project/home.png")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("D:/phonepe project/Statenames.csv")
            df1.State = df2

            fig = px.choropleth(df1,geojson="",
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/Jamuna17/Phonepe_Pulse_Data_Visualization-.git")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("D:/phonepe project/Pulseimg.jpg")                
